...
public class Stockfish {
	...
	private static final String PATH = "C:/stockfish-8-win/Windows/stockfish_8_x64.exe";
	...
	public static void main(String[] args) {
		...
		sf.startEngine();
		System.out.println(sf.getEvalScore("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 1000));
	}
}